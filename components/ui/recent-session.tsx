  ...
  return (
    <Link href="#" className="w-fit focus:outline-none focus:ring h-fit rounded-2xl max-sm:rounded-xl hover:scale-95 active:scale-90 transition-all focus:ring-offset-2 focus:ring-neutral-300">
      ...
      >
        ...
        {<p className="absolute font-medium text-lg text-transparent bg-gradient-to-tr from-black/20 to-neutral-100/50 bg-clip-text bottom-4 left-4 max-lg:text-base ">{lastMessageContent}</p>}
      </BoxCard>
