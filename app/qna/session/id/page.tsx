        ...
        <PageContent>
            <ViewContainer className="flex justify-between gap-[120px]">
                ...
                <section className="qna-question-list flex flex-col items-center">
                    ...
                    // />
                        <BoxCard className={cn('bg-neutral-200 hover:brightness-90 flex flex-col justify-between p-4 min-h-[140px] cursor-pointer')} onClick={()=>setQNum(q.questionId)}>
                    ...
                    <div>
                        <div className="flex flex-col gap-11">
                            ...
                            <div className="answer-wrapper ">
                                ...
                                <Textarea className="answer-box min-h-[300px] w-full px-4 py-2 placeholder:text-sm text-lg" placeholder="Good luck! You will do well" onChange={handleAnsChange} value={storeAns[qNum]}/>
                            </div>
                        </div>
